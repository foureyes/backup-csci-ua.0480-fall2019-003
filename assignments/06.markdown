...
5. (this ones a bit challenging) show the company name, model and max speed of the model of scooter with the highest max speed for every company
	...
	* hint 1: create a query to select the columns that you want
	* hint 2: create a query that only does the aggregation
	...
	* hint 4: here's a good article on how to do it: [group by non aggregate columns from bernardoamc.github.io](http://bernardoamc.github.io/sql/2015/05/04/group-by-non-aggregate-columns/)
